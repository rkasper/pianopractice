...
class PianoPractice:
    ...
    HANON_EXERCISES = [{NAME: '1', URL: 'https://www.hanon-online.com/the-virtuoso-pianist-part-i/hanon-exercise-n-1/'},
    ...
    def exercises_to_practice() -> []:
        return [(random.choice(PianoPractice.SCALES)), (random.choice(PianoPractice.HANON_EXERCISES)),
