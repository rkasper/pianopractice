...
<body>
    ...
    page += '<li class="d-flex flex-column"><a href="' + exercises[0].url + '" target="_blank"><img src="static/image/exercise-img1.png">' + exercises[0].group + ': ' + exercises[0].name + '</a></li>'
    page += '<li class="d-flex flex-column"><a href="' + exercises[1].url + '" target="_blank"><img src="static/image/exercise-img2.png">' + exercises[1].group + ': ' + exercises[1].name + '</a></li>'
    page += '<li class="d-flex flex-column"><a href="' + exercises[2].url + '" target="_blank"><img src="static/image/exercise-img3.png">' + exercises[2].group + ': ' + exercises[2].name + '</a></li>'
	...
	<div class="footer container-md">
		...
		<div class="footer-text">
			<span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">PianoPlay.app</span> by <a xmlns:cc="http://creativecommons.org/ns#" href="https://kasperowski.com/" property="cc:attributionName" rel="cc:attributionURL" target="_blank">Richard Kasperowski</a> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/" target="_blank">Creative Commons Attribution-ShareAlike 4.0 International License</a>.
		</div>
	</div>
