...
def home_page():  # put application's code here
    ...
    page += '<p>Practice your piano exercises just right: the right exercises at the right times; just the right amount of exercise to keep it fun, keep you advancing, and leave you time for the fun stuff on piano&em;playing songs and making music!</p>'
